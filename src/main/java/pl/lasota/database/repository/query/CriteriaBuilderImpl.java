...
import pl.lasota.database.repository.query.field.*;
import pl.lasota.database.repository.query.normalize.AcccentNormalizer;
import pl.lasota.database.repository.query.normalize.LowerCaseNormalizer;
import pl.lasota.database.repository.query.normalize.Normalizable;
import pl.lasota.database.repository.query.normalize.UpperCaseNormalizer;
import pl.lasota.database.repository.query.sort.SimpleSort;
