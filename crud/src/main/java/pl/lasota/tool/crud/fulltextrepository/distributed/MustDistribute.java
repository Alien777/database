...
public class MustDistribute<MODEL> {
    ...
    public MustDistribute(List<CriteriaField<?>> fields, MappingFieldFullText mappingFieldFullText) {
        this.fields = fields;
    ...
    public void process(QueryBuilder queryBuilder, BooleanJunction booleanJunction) {
        fields.stream()
                ...
                .filter(field -> field.getCriteriaType() == CriteriaType.MUST)
