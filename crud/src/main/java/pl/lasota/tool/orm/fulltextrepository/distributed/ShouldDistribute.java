...
public class ShouldDistribute implements Processable {
    ...
    public ShouldDistribute(MappingFieldFullText mappingFieldFullText, QueryBuilder queryBuilder, BooleanJunction booleanJunction) {
